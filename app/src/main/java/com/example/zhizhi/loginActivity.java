...
public class loginActivity extends AppCompatActivity implements View.OnClickListener {
     ...
     * 然后再进行数据表的增、删、改、查操作
     */
    private com.example.zhizhi.other.DBOpenHelper mDBOpenHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEtLoginactivityUserPhone.setText(sp.getString("phone",""));
        pass.setText(sp.getString("passWorld",""));
        mDBOpenHelper = new com.example.zhizhi.other.DBOpenHelper(this);
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.bt_loginactivity_login:
                ...
                if (!TextUtils.isEmpty(userphone)&&!TextUtils.isEmpty(password)) {
                    ArrayList<com.example.zhizhi.other.User> data = mDBOpenHelper.getAllData();
                    boolean match = false;
                    for (int i = 0; i < data.size(); i++) {
                        com.example.zhizhi.other.User user = data.get(i);
